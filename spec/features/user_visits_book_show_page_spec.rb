...
describe 'as a visitor' do
  ...
  before(:each) do
    ...
    @review_5 = @book_1.reviews.create(review_title: "The best book ever", rating: 1, review_text: "I was entertained throughout", user_id: @user_6.id)
    @review_6 = @book_1.reviews.create(review_title: "A little too long", rating: 2, review_text: "I enjoyed this book, but it was long", user_id: @user_7.id)
