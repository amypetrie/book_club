...
describe 'As a visitor' do
  ...
  describe "When I visit a book's page" do
    ...
    it 'I see a delete link for the book' do
      visit book_path(@book_1)

      within(".show_book_info") do
        expect(page).to have_content("Delete")
      end
    end

    it 'I can delete that book by clicking its delete link' do
      visit book_path(@book_1)
